...
export async function irradianceMap(device:GPUDevice, texture:GPUTexture, irradianceTexture:GPUTexture) {
  ...
  commandEncoder.copyTextureToTexture({texture: diffuseStorageTexture}, {texture: irradianceTexture}, [texture.width, texture.height, 6]);
